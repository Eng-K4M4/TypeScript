...
verify.goToDefinition("functionOverloadReference1", "functionOverload1");
verify.goToDefinition("functionOverloadReference2", "functionOverload2");
verify.goToDefinition("brokenOverload", "functionOverload1");
